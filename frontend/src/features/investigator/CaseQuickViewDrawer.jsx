...
// Opens from the eye icon on any view (table row, card, or map pin).
// Shows the full case snapshot plus the navigation actions that used to
// be separate inline links.
    ...
    >
      {caseRecord && (
        <>
          ...
          {/* Same destinations the old inline table-row links pointed to */}
